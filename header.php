...
//                                
                                //echo '
                               //<div class="dropdownn">
                                  //<a href="#" class="dropdownn" data-toggle="modal" data-target="#myModal" ><i class="fa fa-user-o"></i> HI '.$row["admin_name"].'</a>
                  ...
                  if(isset($_SESSION["uid"])){
                      ...
                      <div class="dropdownn">
                        ...
                        <div class="dropdownn-content">
                          ...
                          <a href="" data-toggle="modal" data-target="#Modal_register"><i class="fa fa-user-plus" aria-hidden="true"></i>Đăng kí</a>                                    
                        </div>
                      </div>';
                  }                                             
                  ?>                              
					...
					<div class="row">
						<div class="col-md-3">
							<div class="header-logo">
								<a href="#" class="logo">
                <img src="./img/242162856_4556505621061387_7856898607697508187_n.png" alt="" width="80" height="80">
						...
						<div class="col-md-6">
							<div class="header-search">
								<form>
									...
									<button type="submit" id="search_btn" class="search-btn" style="background-color: red;">Tìm Kiếm</button>
								</form>
							</div>
						</div>
